        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-center align-items-center mb-4">
                <div class="text-center">
                    <h1 class="h2 mb-0 text-primary font-weight-bold">Profil Pengguna</h1>
                    <p class="mb-0 text-secondary">Kelola informasi akun Anda</p>
                </div>
            </div>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="card profile-card">
                        <div class="card-body text-center">
                            <!-- Profile Picture -->
                            <div class="profile-img-container mb-3" title="Klik untuk mengubah foto profil">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="previewImage" src="" alt="Profile Preview" class="img-fluid rounded">
            </div>
